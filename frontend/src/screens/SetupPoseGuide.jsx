 ...
 *
 * Two modes:
 * 1. Frontend owns webcam: uses useMediaPipePose to run in-browser detection.
 * 2. Backend owns webcam: pass landmarks from WS state (skip MediaPipe).
 *
...
export default function SetupPoseGuide({
  ...
  // Use backend landmarks when available
  useEffect(() => {
    if (backendLandmarks) {
